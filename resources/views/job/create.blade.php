            ...
            <form action="#" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fullname" name="title" class="form-control" placeholder="eg. Full Stack Frontend">
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="option-job-type-1">
                    <input type="radio" id="option-job-type-1" name="job-type" value="{{ $jobType->id }}"> 
                    {{ $jobType->title }}
                  </label>
                </div>
                @endforeach
