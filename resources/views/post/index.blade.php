...
<!-- 
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <label for="option-job-type-1">
                    <input type="radio" id="option-job-type-1" value="{{ $jobType['id'] }}" name="type_id"> {{ $jobType['title'] }}
                  </label>
                </div>
                @endforeach
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <textarea name="description" class="form-control" id="blya" cols="30" rows="5"></textarea>
                </div>
              </div>
